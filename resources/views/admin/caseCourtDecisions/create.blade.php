...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.caseCourtDecision.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.case-court-decisions.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('court_reff_code') ? 'is-invalid' : '' }}" type="text" name="court_reff_code" id="court_reff_code" value="{{ old('court_reff_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('court_date') ? 'is-invalid' : '' }}" type="text" name="court_date" id="court_date" value="{{ old('court_date') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('court_decisions') ? 'is-invalid' : '' }}" name="court_decisions" id="court_decisions">{{ old('court_decisions') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('court_notes') ? 'is-invalid' : '' }}" type="text" name="court_notes" id="court_notes" value="{{ old('court_notes', '') }}">

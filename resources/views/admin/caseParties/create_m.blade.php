...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.caseParty.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="/admin/case-parties-store_two" enctype="multipart/form-data">
<!--        <form method="POST" action="{{ route("admin.case-parties.store") }}" enctype="multipart/form-data">-->
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('party_name') ? 'is-invalid' : '' }}" type="text" name="party_name" id="party_name" value="{{ old('party_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('party_address') ? 'is-invalid' : '' }}" type="text" name="party_address" id="party_address" value="{{ old('party_address', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('party_phone') ? 'is-invalid' : '' }}" type="text" name="party_phone" id="party_phone" value="{{ old('party_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('party_mobile') ? 'is-invalid' : '' }}" type="text" name="party_mobile" id="party_mobile" value="{{ old('party_mobile', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('party_email') ? 'is-invalid' : '' }}" type="email" name="party_email" id="party_email" value="{{ old('party_email') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('party_notes') ? 'is-invalid' : '' }}" type="text" name="party_notes" id="party_notes" value="{{ old('party_notes', '') }}">

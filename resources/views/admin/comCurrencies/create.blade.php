    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.com-currencies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('crncy_desc_a') ? 'is-invalid' : '' }}" type="text" name="crncy_desc_a" id="crncy_desc_a" value="{{ old('crncy_desc_a', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('crncy_desc_l') ? 'is-invalid' : '' }}" type="text" name="crncy_desc_l" id="crncy_desc_l" value="{{ old('crncy_desc_l', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('crncy_symbol') ? 'is-invalid' : '' }}" type="text" name="crncy_symbol" id="crncy_symbol" value="{{ old('crncy_symbol', '') }}">

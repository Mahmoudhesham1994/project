...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.docBorrower.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.doc-borrowers.update", [$docBorrower->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="borrower_name">{{ trans('cruds.docBorrower.fields.borrower_name') }}</label>
                <input class="form-control {{ $errors->has('borrower_name') ? 'is-invalid' : '' }}" type="text" name="borrower_name" id="borrower_name" value="{{ old('borrower_name', $docBorrower->borrower_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('borrower_address') ? 'is-invalid' : '' }}" type="text" name="borrower_address" id="borrower_address" value="{{ old('borrower_address', $docBorrower->borrower_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('borrower_desc') ? 'is-invalid' : '' }}" type="text" name="borrower_desc" id="borrower_desc" value="{{ old('borrower_desc', $docBorrower->borrower_desc) }}">

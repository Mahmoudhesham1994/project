    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.report-types.update", [$reportType->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rep_type_desc_a') ? 'is-invalid' : '' }}" type="text" name="rep_type_desc_a" id="rep_type_desc_a" value="{{ old('rep_type_desc_a', $reportType->rep_type_desc_a) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rep_type_desc_l') ? 'is-invalid' : '' }}" type="text" name="rep_type_desc_l" id="rep_type_desc_l" value="{{ old('rep_type_desc_l', $reportType->rep_type_desc_l) }}">

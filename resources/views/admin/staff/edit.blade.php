    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.staff.update", [$staff->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('staff_no') ? 'is-invalid' : '' }}" type="text" name="staff_no" id="staff_no" value="{{ old('staff_no', $staff->staff_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('staff_name') ? 'is-invalid' : '' }}" type="text" name="staff_name" id="staff_name" value="{{ old('staff_name', $staff->staff_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" type="text" name="notes" id="notes" value="{{ old('notes', $staff->notes) }}">
                @if($errors->has('notes'))
